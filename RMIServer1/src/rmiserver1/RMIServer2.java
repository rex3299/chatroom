...
public class RMIServer2 extends UnicastRemoteObject implements RMIInterface {
    ...
    public RMIServer2() throws RemoteException, NotBoundException, MalformedURLException {
        super();
...
//        serverNames[2] = "rmi://127.0.0.1:20002/hellton20002";
    ...
    public static void main(String[] args) throws MalformedURLException, NotBoundException {
        ...
        try {
                ...
                //reg.rebind(name1, new RMIServer2());
                Naming.rebind(servName, new RMIServer2());
    ...
    public synchronized void insert(String name) throws RemoteException {
        ...
        try {
            ...
            Logger.getLogger(RMIServer2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

...
public class RMIServer3 extends UnicastRemoteObject implements RMIInterface {
    ...
    public RMIServer3() throws RemoteException, NotBoundException, MalformedURLException {
        super();
...
//        serverNames[2] = "rmi://127.0.0.1:20002/hellton20002";
    ...
    public static void main(String[] args) throws MalformedURLException, NotBoundException {
        ...
        try {
                ...
                //reg.rebind(name1, new RMIServer3());
                Naming.rebind(servName, new RMIServer3());
    ...
    public synchronized void insert(String name) throws RemoteException {
        ...
        try {
            ...
            Logger.getLogger(RMIServer3.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
